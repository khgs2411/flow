...
**v1.6.4** - Fixed plugin updater (2025-11-09)

**Changes**:

- - Plugin version now updated automatically\n
See the [v1.6.4 release](https://github.com/khgs2411/flow/releases/tag/v1.6.4) for full details.
