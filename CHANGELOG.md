...
**v1.4.0** - Reworked agent skills (2025-11-02)

**Changes**:

- - Completely reworked the agent skills to better follow the best practiced based on Anthropic's documentations\n
See the [v1.4.0 release](https://github.com/khgs2411/flow/releases/tag/v1.4.0) for full details.
